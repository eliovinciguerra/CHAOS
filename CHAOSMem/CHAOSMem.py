...
class CHAOSMem(SimObject):
    ...
    addr_start = Param.Addr(0, "Start address of the memory-mapped range (default: NULL)")
    addr_end = Param.Addr(0, "End address of the memory-mapped range (default: NULL)")